...
class m150414_195800_timeline_event extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(
            ...
            [
                ['backend', 'admin-user', 'signup', json_encode(['public_identity' => 'webmaster', 'user_id' => 1, 'created_at' => time()]), time()],
                ['backend', 'admin-user', 'signup', json_encode(['public_identity' => 'manager', 'user_id' => 2, 'created_at' => time()]), time()],
                ['frontend', 'user', 'signup', json_encode(['public_identity' => 'user', 'user_id' => 1, 'created_at' => time()]), time()]
            ]
        );
    }
